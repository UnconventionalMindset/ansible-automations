...
k describe certificate umhomelab-com # Should output: The certificate has been successfully issued
# If the cert does not appear, the issue might be on the name used in traefik-default-tls.yaml
# If the cert does not appear in traefik, try deleting the pod or CTRL+F5
